    ...
    if(formData!.validate()){
      ...
      try{
        ...
        userCredential = await instance.createUserWithEmailAndPassword(
            email: this._Email!, password:"admin"+this._Password!);
        // ------------------------Creat Admin Collection
        CollectionReference AdminRef = await FirebaseFirestore.instance.collection("Admin");
        AdminRef.doc(FirebaseAuth.instance.currentUser!.uid).set({
          "Name" : this._Name,
          "Age" :this._Age,
        ...
        if(e.code=="email-already-in-use"){
          var snackBar = SnackBar(content: Text("EmailAlready in use"),);
            ...
            child: Stack(
              children: [
                Positioned(
                    right: -4,
                    top: -115,
                    child: Image.asset("assets/images/DropOfBlood1.png")
                ),
                Positioned(
                    top: 35,
                    right: 10,
